...
def makelclist(basedir,
    ...
    and write them to the requested output CSV file. These keys should be
    pointers to scalar values (i.e. something like objectinfo.ra is OK, but
    something like rjd won't work because it's a vector).
    ...
    If makecoordindex is not None, it must be a two-element list of the column
    names for the right ascension and declination for each object. These will be
