...
def runcp_consumer_loop(
    ...
    workdir : str
        ...
        be uploaded to the specified S3 output bucket, and then periodically
    ...
    cache_clean_timer_seconds : float
        The amount of time in seconds to wait before periodically removing
        output checkplot pickles from the work directory. Also sets how old each
        output checkplot pickle file must be before it's marked for deletion.
