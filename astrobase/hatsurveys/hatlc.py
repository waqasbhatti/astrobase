...
read_csvlc(lcfile):
    ...
    This reads a CSV light curve produced by the HAT data server into an lcdict.
...
read_and_filter_sqlitecurve(lcfile, columns=None, sqlfilters=None,
    ...
    This reads a sqlitecurve file and optionally filters it, returns an lcdict.
...
normalize_lcdict_byinst(lcdict, magcols='all', normto='sdssr',
    ...
    lcdict that specify various instrument properties. The default normalization
